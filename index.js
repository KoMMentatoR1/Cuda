...
function draw_circle_diagram(){
  ...
  for (var $i = 0; $i < $circle_diagrams.length; $i++){
    var $svg_width =    $circle_diagrams[$i].clientHeight
    ...
    var $text2 = $circle_diagrams[$i].querySelector('.circle-diagram__text2');
    ...
    $text.setAttribute("y", $svg_height/2 + 15);

    $text2.textContent = "%";
    $text2.setAttribute("y", $svg_height/2 + 15);
